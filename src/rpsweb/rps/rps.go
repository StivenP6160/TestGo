...
// Mensajes para cuando gana (est es un slice)
...
// Mensajes para cuando se pierde
var losesMessages = []string{
	"¡Qué lástima!",
	"¡Inténtalo de nuevo!",
...
func PlayRound(playerValue int) Round {
	...
	case SCISSORS:
		...
		computerChoice =  "La computadora eligió SCISSORS"
	}
	...
	if playerValue == computerValue {
		...
		message = losesMessages[messageInt]
	}
